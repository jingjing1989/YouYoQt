...
void MyLeftBar::initTreeWIdget() {
  ...
  icon.addPixmap(QPixmap(":/image/files/images/leftbar/collect_sle.png.png"), QIcon::Selected);
#endif
  icon.addPixmap(QPixmap(":/images/res/images/leftbar/collect.png"), QIcon::Normal);
  group1->setIcon(0, icon);
...
void MyLeftBar::setshrinkTree(int height) { this->setFixedWidth(height); }

int MyLeftBar::shrinkTree() { return this->width(); }
