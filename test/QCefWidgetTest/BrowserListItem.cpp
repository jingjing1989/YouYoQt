...
BrowserListItem::BrowserListItem(CefWnd *pCefWnd, QWidget *parent) : QWidget(parent), pCefWnd_(pCefWnd) {
  setupUi();
...
CefWnd *BrowserListItem::cefWnd() { return pCefWnd_; }
...
void BrowserListItem::setupUi() {
  ...
  pushButtonVisible_->setStyleSheet("QPushButton[status=\"visible\"] {border: none;image: url(:/QCefWidgetTest/images/visible.svg);} "
                                    "QPushButton[status=\"invisible\"] {border: none;image: url(:/QCefWidgetTest/images/invisible.svg);}");
  pushButtonVisible_->setProperty("status", "invisible");
  ...
  pushButtonInvokeJS_->setStyleSheet("QPushButton {border: none;image: url(:/QCefWidgetTest/images/javascript_n.svg);} QPushButton:hover {border: none; image: "
                                     "url(:/QCefWidgetTest/images/javascript_h.svg);}");
  ...
  pushButtonDevTools_->setStyleSheet("QPushButton {border: none;image: url(:/QCefWidgetTest/images/devtools_n.svg);} QPushButton:hover {border: none; image: "
                                     "url(:/QCefWidgetTest/images/devtools_h.svg);}");
  ...
  pushButtonClose_->setStyleSheet("QPushButton {border: none;image: url(:/QCefWidgetTest/images/close_n.svg);} QPushButton:hover {border: none; image: "
                                  "url(:/QCefWidgetTest/images/close_h.svg);}");
