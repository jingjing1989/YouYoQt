...
SystemSettingMainWindow::SystemSettingMainWindow(QWidget *parent) : QMainWindow(parent), ui(new Ui::SystemSettingMainWindow) {
  ui->setupUi(this);
...
#endif
  connect(ui->pushButton_changepassword, &QPushButton::clicked, this, [=]() { ui->stackedWidget_setting->setCurrentIndex(0); });
...
SystemSettingMainWindow::~SystemSettingMainWindow() { delete ui; }
