...
CEF Version:      80.1.14+ga33bdbc+chromium-80.0.3987.149
CEF URL:          https://bitbucket.org/chromiumembedded/cef.git
                  @a33bdbcdb44e22785806f399b51dd77410673ec0

Chromium Version: 80.0.3987.149
Chromium URL:     https://chromium.googlesource.com/chromium/src.git
                  @45ebe0933997167e42e992e566a6c6e55f514ba1

This distribution contains all components necessary to build and distribute an
application using CEF on the Windows platform. Please see the LICENSING
section of this document for licensing terms and conditions.

CEF chrome80版本,不需要新版本,80版本支持了optinal-chain就够了,
目前源码中不会放libcef.all,请自行下载包把Debug和Release的放入其中,msvc2017编译
--------------------------------------------------------------
下载地址: https://cef-builds.spotifycdn.com/cef_binary_80.1.14+ga33bdbc+chromium-80.0.3987.149_windows64.tar.bz2
